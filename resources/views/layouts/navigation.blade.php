    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @auth
                <div class="flex justify-between items-center w-full">
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex h-full">
                        ...
                        <x-nav-link href="{{ route('dashboard-categories') }}"
                            :active="request()->routeIs('dashboard-categories')">
                            {{ __('Categories') }}
                        </x-nav-link>
                        <x-nav-link href="{{ route('dashboard-tags') }}" :active="request()->routeIs('dashboard-tags')">
                            {{ __('Tags') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden sm:flex sm:items-center sm:ms-6">

                        <div class="flex justify-between items-center bg-black-100">
                            <a href="/posts"
            ...
            @guest
                <div class="flex justify-between items-center bg-black-100">
                    <a href="{{ route('login') }}"
                        class="mx-4 text-gray-500 hover:underline transition-all duration-300">Login</a>
                </div>
            @endguest
